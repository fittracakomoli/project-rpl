    ...
    <section id="home" class="pt-32 bg-cover bg-center">
        <div class="py-16 px-4 mx-auto max-w-screen-xl text-center lg:px-12">
            <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full " role="alert">
                <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">Baru</span> <span class="text-sm font-medium">Event incaranmu sudah tersedia</span> 
    ...
    <section class="bg-white px-4 py-8 antialiased md:py-16">
        <div class="mx-auto grid max-w-screen-xl rounded-lg bg-gray-50 p-4 md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16">
          <div class="lg:col-span-5 lg:mt-0">
            <a href="#">
              <img class="mb-4 h-56 w-56 sm:h-96 sm:w-96 md:h-full md:w-full" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-components.svg" alt="peripherals" />
            </a>
          </div>
          <div class="me-auto place-self-center lg:col-span-7">
            <h1 class="mb-3 text-2xl font-bold leading-tight tracking-tight text-gray-900 md:text-4xl">
              Dapatkan Harga Spesial Event - Event di Kotamu
            </h1>
            <p class="mb-6 text-gray-500">Reserve your new Apple iMac 27” today and enjoy exclusive savings with qualified activation. Pre-order now to secure your discount.</p>
            <a href="#" class="inline-flex items-center justify-center rounded-lg bg-primary-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300"> Pre-order now </a>
          </div>
        </div>
      </section>
            ...
            <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
              ...
              <div class="p-6">
                ...
                <div class="mt-2 flex items-center gap-4">
                  <p class="text-gray-400">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestias, numquam.</p>
                </div>
    ...
    <section class="bg-white py-8 antialiased">
        <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
          <div class="content-center justify-self-start md:col-span-7 md:text-start">
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight md:max-w-2xl md:text-5xl xl:text-6xl">Jangan!<br />Sampai Ketinggalan.</h1>
            <p class="mb-4 max-w-2xl text-gray-500 md:mb-12 md:text-lg lg:mb-5 lg:text-xl">Jelajahi dan Segera Dapatkan Tiket Event yang Kamu Sukai.</p>
            <a href="#" class="inline-block rounded-lg bg-primary-700 px-6 py-3.5 text-center font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 ">Beli Sekarang!</a>
          </div>
